...
!$Omp parallel num_threads(6) default(none) private(k, i_site, j_site,i)&
!$Omp firstprivate(Omega, SE_old, DELTA, HK_k, INVHK_k)&
!$omp shared(HK,NK,Ef,Nsite)&
!$OMP reduction(+:Lattice_G)&
