...
rotational_theta=2.0d0*dasin(1.0d0/(SQRT(13.0d0)))
...
do i=1,n_cell
   do j_atom=1,2
      Rxoy_frac_coor_L1(i,1,j_atom)=xoy_frac_coor_L1(i,1,j_atom)*dcos(pi/6.0d0-rotational_theta/2.0d0)+&
                                   &+xoy_frac_coor_L1(i,2,j_atom)*dsin(pi/6.0d0-rotational_theta/2.0d0)
      Rxoy_frac_coor_L1(i,2,j_atom)=-xoy_frac_coor_L1(i,1,j_atom)*dsin(pi/6.0d0-rotational_theta/2.0d0)+&
                                   &+xoy_frac_coor_L1(i,2,j_atom)*dcos(pi/6.0d0-rotational_theta/2.0d0)
   end do
end do
do i=1,n_cell
   do j_atom=1,2
...
do i=1,n_cell
   do j_atom=1,2
Rxoy_frac_coor_L2(i,1,j_atom)=xoy_frac_coor_L2(i,1,j_atom)*dcos(pi/6.0d0+rotational_theta/2.0d0)+&
                             &+xoy_frac_coor_L2(i,2,j_atom)*dsin(pi/6.0d0+rotational_theta/2.0d0)
Rxoy_frac_coor_L2(i,2,j_atom)=-xoy_frac_coor_L2(i,1,j_atom)*dsin(pi/6.0d0+rotational_theta/2.0d0)+&
                             &+xoy_frac_coor_L2(i,2,j_atom)*dcos(pi/6.0d0+rotational_theta/2.0d0)
   end do
end do
do i=1,n_cell
   do j_atom=1,2
